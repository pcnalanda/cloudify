...
$conf->set('group.id', 'callcenter-group');  // Unique group ID
...
echo "Waiting for messages to update call center application...\n";
    ...
    if ($message->err) {
        switch ($message->err) {
            case RD_KAFKA_RESP_ERR_NO_ERROR:
                ...
                // Code to update call center application
                echo "Updated call center with user: " . $userData['user_id'] . "\n";
                break;
